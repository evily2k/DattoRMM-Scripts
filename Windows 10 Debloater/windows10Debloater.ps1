<#
TITLE: Windows 10 Debloater V3
PURPOSE: Remove Windows Bloatware and other junk and disable tracking
CREATOR: Dan Meddock
CREATED: 14MAR2022
LAST UPDATED: 09JUNE2022
#>
...
Write-Output "Removing Blacklisted apps."
DebloatBlacklist
...
UnpinStart
Write-Output "Removes 3D Objects from the 'My Computer' submenu"
Remove3dObjects
Write-Output "Set Windows to Dark Mode"
